...
class PlayState extends MusicBeatState
{
	...
	// Preload R.A.M Characters
	public static var hexSun:Character;
	public static var gfSun:Character;
	public static var bfSun:Boyfriend;
	public static var hexNight:Character;
	public static var gfNight:Character;
	public static var bfNight:Boyfriend;
	...
	// Game lags hard without this
	public function preloadRAMChar()
	{
		hexSun = new Character();
		bfSun = new Boyfriend();
		gfSun = new Character();
		hexNight = new Character();
		bfNight = new Boyfriend();
		gfNight = new Character();

		gfSun.setCharacter(0, 0, 'gf-sun');
		gfNight.setCharacter(0, 0, 'gf-night');

		hexNight.setCharacter(0, 0, 'hex-night');
		bfNight.setCharacter(0, 0, 'bf-night');
		hexSun.setCharacter(0, 0, 'hex-sun');
		bfSun.setCharacter(0, 0, 'bf-sun');
